  ...
  <div id="carouselExampleCaptions" class="carousel slide">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h1 class="mb-4 emboss-htext">Last Chance, Nike Promotion</h1>
          </div>
        </div>
        <div class="carousel-item">
          <img src="/images/3.png" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <h1 class="mb-4 emboss-htext">Kobe, The Legend</h1>
          </div>
        </div>
        <div class="carousel-item">
          <img src="/images/4.png" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <h1 class="mb-4 emboss-htext">Currently, in our GolfWRX buy/sell/trade (BST)</h1>
          </div>
        </div>
        <div class="carousel-item">
    ...
    <div class="card">
      ...
      <div class="card-body bg-dark text-white">
        ...
        <p class="card-text bg-dark alignjustified text-white">
          ...
          Bowerman's design led to the introduction of the "Moon Shoe" in 1972, so named because the waffle tread was said to resemble the footprints left by astronauts on the Moon. Further refinement resulted in the "Waffle Trainer" in 1974, which helped fuel the explosive growth of Blue Ribbon Sports/Nike.<br/><br/>
        ...
        <button type="button" class="btn btn-primary">Go to Nike Space</button>
      </div>
    </div>
  
    <div class="mb-3 mt-1 text-white">
      <Footer/>
  </div>
  </div>