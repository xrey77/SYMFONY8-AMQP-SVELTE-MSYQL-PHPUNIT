...
<div class="container-fluid bg-danger">
    <img class="contact" src="/images/contact.png" alt=""/>
    <div class="card border-0 bg-danger contact-top">
        <h3 class="text-primary">Headquarters</h3>
        <div class="card-text alignjustified p3 text-white">
            <p class="mx-2">
        ...
        <h3 class="mt-1 text-primary">Ownership</h3>
        <div class="card-text alignjustified p3 text-white">

           &bullet; Vanguard (7.23%)<br/>
           &bullet; BlackRock (5.93%)<br/>
           &bullet; State Street Global Advisors (3.71%)<br/>
           &bullet; Travis Knight (3.14%)<br/>
           &bullet; Knight Foundation (1.95%)<br/>
           &bullet; Capital Research and Management Company (1.94%)<br/>
           &bullet; Geode Capital Management (1.57%)<br/>
           &bullet; Wellington Management Company (1.48%)<br/>
           &bullet; AllianceBernstein (1.32%)            
        </div>        
        <br/>
    </div>
